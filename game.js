...
function preload() {
    ...
    game.load.spritesheet('tulipallo', 'assets/tulipallo.png', 64, 64);
...
function create() {
    ...
    // tulipallot
    tulipallot = game.add.group();
    tulipallot.enableBody = true;
